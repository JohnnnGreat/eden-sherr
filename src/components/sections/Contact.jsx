              ...
              <div>
                ...
                >
                  <div className="grid gap-6">
                    <div>
                      <label className="block text-xs font-bold text-ink-900 mb-2 uppercase tracking-wider">Full Name *</label>
                      <input name="contact" type="text" className="w-full px-4 py-3 rounded-lg border border-light focus:outline-none focus:ring-2 focus:ring-copper-400" placeholder="Your name" required />
                    </div>

                    <div>
                      <label className="block text-xs font-bold text-ink-900 mb-2 uppercase tracking-wider">Email Address *</label>
                      <input name="email" type="email" className="w-full px-4 py-3 rounded-lg border border-light focus:outline-none focus:ring-2 focus:ring-copper-400" placeholder="your@email.com" required />
                    </div>

                    <div>
                      <label className="block text-xs font-bold text-ink-900 mb-2 uppercase tracking-wider">Company & Country *</label>
                      <input name="company" type="text" className="w-full px-4 py-3 rounded-lg border border-light focus:outline-none focus:ring-2 focus:ring-copper-400" placeholder="e.g. Spice Co. Ltd, Germany" required />
                    </div>

                    <div>
                      <label className="block text-xs font-bold text-ink-900 mb-2 uppercase tracking-wider">Product of Interest *</label>
                      <select name="product" className="w-full px-4 py-3 rounded-lg border border-light focus:outline-none focus:ring-2 focus:ring-copper-400 bg-white" required>
                        <option value="">Select a product</option>
                        <option value="Dried Split Ginger">Dried Split Ginger</option>
                        <option value="Ginger Powder">Ginger Powder</option>
                        <option value="Fresh Rhizomes">Freshly Harvested Rhizomes</option>
                      </select>
                    </div>
