      ...
      <div className="w-full bg-charcoal-900 relative flex flex-col items-center pt-16 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-md w-full relative z-10 flex flex-col items-center">
          ...
          >
            ...
            <p className="text-cream/60 text-sm tracking-wide mt-2">{siteConfig.companyName}</p>
          </motion.div>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className="text-charcoal-900 font-medium text-[15px]">{siteConfig.contact.phoneDisplay}</p>
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className="text-charcoal-900 font-medium text-[15px]">{siteConfig.contact.salesEmail}</p>
          ...
          <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-charcoal-900/5">
            ...
            <div className="flex-1 text-left">
              <p className="text-charcoal-900 font-medium text-[15px] leading-tight mt-0.5">
                ...
                <br />
                {siteConfig.address.streetLine2}, {siteConfig.address.city}
              </p>
