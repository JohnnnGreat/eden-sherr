...
export const originHighlights = [
  {
    title: "Soil & Climate Advantage",
    detail:
      "Southern Kaduna's soil profile and climate produce ginger known for strong aroma and pungency.",
  },
  {
    title: "Farming Heritage",
    detail:
      "The region has deep ginger-growing experience passed through generations of farming families.",
  },
  {
    title: "Commercial Potential",
    detail:
      "When quality processing and documentation are aligned, this origin can compete strongly in global markets.",
  },
];
